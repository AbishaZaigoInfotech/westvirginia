                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control ts"  name="date_format" id="date-format" >
                              ...
                              @foreach(config('stations.settings.date_format') as $key => $value)
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control ts"  name="date_time_format" id="date-time-format" >
                              ...
                              @foreach(config('stations.settings.date_time_format') as $key => $value)
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control ts"  name="time_format" id="time-format" >
                              ...
                              @foreach(config('stations.settings.time_format') as $key => $value)
