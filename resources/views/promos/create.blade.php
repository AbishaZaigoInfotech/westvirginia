@extends('larasnap::layouts.app', ['class' => 'promo-create'])
@section('title','Promo Management')
@section('content')
<!-- Page Heading  Start-->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800">Add Promo</h1>
</div>
<!-- Page Heading End-->				  
<!-- Page Content Start-->				  
<div class="row">
      ...
      <div class="card shadow mb-4">
         <div class="card-body">
            <div class="card-body">
               ...
               <br> <br> 
               <form method="POST" action="{{ route('promos.store') }}"  enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                  @csrf
                  <div class="row">
                     <div class="col-md-4">
