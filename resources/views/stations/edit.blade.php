                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select name="format" id="format" class="form-control">
                            ...
                            <option value="0"{{ $station->format == 1 ? 'selected' : '' }}>Rock</option>
                            <option value="1"{{ $station->format == 2 ? 'selected' : '' }}>Country</option>
                            <option value="2"{{ $station->format == 3 ? 'selected' : '' }}>AC</option>
                            <option value="3"{{ $station->format == 4 ? 'selected' : '' }}>CHR</option>
                            <option value="4"{{ $station->format == 5 ? 'selected' : '' }}>News/Talk</option>
                           </select>
                           @error('format')
                           <span class="text-danger">{{ $message }}</span>
                           @enderror 							
