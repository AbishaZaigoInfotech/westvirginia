...
class UserRequest extends FormRequest
{
    ...
    // $zipCodeSize = config('larasnap.module_list.user.zip_code_size') ?? 10;
	...
	public function messages()
	{
		return [
            ...
            'pincode.min'      => 'The zipcode field must be atleast 4 characters.',
            'pincode.max'      => 'The zipcode field may not be greater than 12 characters.',			
		];
